  ...
  return (
    <div className='flex justify-between lg:justify-start gap-8 text-sm text-neutral-950 font-orbitron'>
      <div className='flex flex-col'>
        <div className='text-xs mb-1'>{t.footer.version}</div>
        <div className='font-bold'>{t.footer.edition}</div>
      </div>
      <div className='flex flex-col items-end lg:items-start'>
        <div className='text-xs mb-1'>{t.footer.localTime}</div>
